            ...
            <AnimatePresence>
                {open && (
                    <motion.div
                        ...
                        className="absolute right-4 top-[72px] w-56 space-y-4 rounded-xl border border-white/10 bg-black/70 p-4 shadow-xl backdrop-blur supports-[backdrop-filter]:bg-black/50 md:hidden"
                    >
                        {navItems.map((item) => (
                            <Link
                                key={item.href}
